...
export const projects = [
  ...
  },
  {
    ...
    text: "Personal Fitness Coach Web app built for Dawhacks2024. Provides personalized workout plans tailored to your unique needs and preferences.",
    date: "March 2024",
    status: "done",
    imageUrl: coachme,
  ...
  },
  {
    ...
    text: "Navigate the snake to collect food, grow in length, and avoid collisions with the walls or yourself. Implemented game loops, event handling, and simple graphics using the Pygame library.",
